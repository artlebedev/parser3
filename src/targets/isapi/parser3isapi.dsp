...
# Begin Custom Build - Collecting $Id: parser3isapi.dsp,v 1.22 2001/09/26 10:32:26 parser Exp $, creating ident.C...
InputPath=..\..\ident.awk
...
"ident.C" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	...
	%tools%\cat *.h *.C | %tools%\gawk -f \parser3project\parser3\src\ident.awk -v project=parser3isapi >> ident.C.new 
