...
static const char* IDENT_MAIL_C="$Date: 2003/07/24 11:31:20 $";
...
static void sendmail(Request& r, 
	...
	if(vmail_conf && 
		(server_port=vmail_conf->get_hash()->get(StringBody("SMTP")))) {
	...
	String in(message_cstr); String out; String err;
