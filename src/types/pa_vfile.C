...
volatile const char * IDENT_PA_VFILE_C="$Id: pa_vfile.C,v 1.74 2016/12/23 15:30:16 moko Exp $" IDENT_PA_VFILE_H;
...
HashStringValue *VFile::get_hash() { Value *prefetch=get_element(text_name); return &ffields; }
