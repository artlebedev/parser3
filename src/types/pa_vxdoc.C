...
static const char* IDENT_VXDOC="$Date: 2002/08/13 15:55:45 $";
...
/// VXdoc: $CLASS,$method
Value *VXdoc::get_element(const String& aname, Value *aself, bool looking_down) { 
	// up
	if(Value *result=VXnode::get_element(aname, aself, looking_down))
		return result;
