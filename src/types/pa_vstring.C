...
volatile const char * IDENT_PA_VSTRING_C="$Id: pa_vstring.C,v 1.31 2012/06/15 06:13:11 misha Exp $" IDENT_PA_VSTRING_H;
...
VFile* VString::as_vfile(String::Language lang, const Request_charsets* charsets) {
	...
	result.set(false/*not tainted*/, true/*text*/, sbody.cstrm(), sbody.length());
	return &result;
}
