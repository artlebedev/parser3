...
static const char * const IDENT_VXNODE_H="$Date: 2005/07/28 11:23:03 $";
...
public: // Value
	...
	/// VXnode: $nodeValue
	override const Junction* put_element(Value& self, const String& aname, Value* avalue, bool replace);
