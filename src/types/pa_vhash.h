...
#define IDENT_PA_VHASH_H "$Id: pa_vhash.h,v 1.85 2024/09/10 19:09:56 moko Exp $"
...
public: // usage
	...
	virtual void add(Value* avalue)=0;
};
...
public: // usage
	...
	override void add(Value* avalue) { fhash.put(String::Body::Format(fhash.count()), avalue); }
