...
volatile const char * IDENT_EXECUTE_C="$Id: execute.C,v 1.377 2015/10/21 23:48:45 moko Exp $" IDENT_PA_OPCODE_H IDENT_PA_OPERATION_H IDENT_PA_VCODE_FRAME_H IDENT_PA_WWRAPPER_H;
