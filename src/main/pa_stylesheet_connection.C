...
volatile const char * IDENT_PA_STYLESHEET_CONNECTION_C="$Id: pa_stylesheet_connection.C,v 1.16 2026/04/25 13:38:46 moko Exp $" IDENT_PA_STYLESHEET_CONNECTION_H;
