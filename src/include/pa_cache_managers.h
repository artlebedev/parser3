/** @file
	...
	$Date: 2003/07/24 11:31:21 $
*/

#ifndef PA_CACHE_MANAGERS_H
#define PA_CACHE_MANAGERS_H

static const char* IDENT_CACHE_MANAGERS_H="$Date: 2003/07/24 11:31:21 $";
...
class Cache_managers: public Hash<const StringBody, Cache_manager*> {
public:
