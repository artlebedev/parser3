...
static const char * const IDENT_OPCODE_H="$Date: 2009/05/20 13:29:46 $";
...
#define OPTIMIZE_BYTECODE_CONSTRUCT
...
enum OPCODE {
	...
	OP_ROOT_CONSTRUCT_EXPR, OP_ROOT_CONSTRUCT_VALUE,
	OP_WRITE_CONSTRUCT_EXPR, OP_WRITE_CONSTRUCT_VALUE,
#endif
	//@}
